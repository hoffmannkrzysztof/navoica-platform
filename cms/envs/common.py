...
TIME_ZONE = 'Europe/Warsaw'  # http://en.wikipedia.org/wiki/List_of_tz_zones_by_name
LANGUAGE_CODE = 'pl'  # http://www.i18nguy.com/unicode/language-identifiers.html
...
############## Machina forum & ckeditor configuration #########################
